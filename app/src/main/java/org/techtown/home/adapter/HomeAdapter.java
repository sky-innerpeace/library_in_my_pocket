...
import org.techtown.home.FirebaseHelper;
...
import org.techtown.home.activity.PostActivity;
import org.techtown.home.view.ReadContentsView;
...
public class HomeAdapter  extends RecyclerView.Adapter<HomeAdapter.MainViewHolder>{
    ...
    public HomeAdapter.MainViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {//게시물 클릭시 intent
