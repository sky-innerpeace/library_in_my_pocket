...
public class SnsHomeAdapter extends RecyclerView.Adapter<SnsHomeAdapter.MainViewHolder>{
    ...
    public SnsHomeAdapter(Activity activity, ArrayList<SnsPostInfo> myDataset) {
    ...
    @NonNull
    @Override
    public SnsHomeAdapter.MainViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
